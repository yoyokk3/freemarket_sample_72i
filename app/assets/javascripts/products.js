...
//   $('previewBtn').on('change', '.js-file', function(e) {
...
//       $('.main__box__image1').append(buildFileField(fileIndex[0]));
//       fileIndex.shift();
//       // 末尾の数に1足した数を追加する
...
//   $('.previewBtn').on('click', '.js-remove', function() {
//     const targetIndex = $(this).parent().data('index');
...
//     if ($('.js-file').length == 0) $('.previewBtn').append(buildFileField(fileIndex[0]));
//   });
// });
